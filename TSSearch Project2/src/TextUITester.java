 ...
 * a String of text
 * input (that will be fed to System.in as if entered by the user), and then 2)
 * capturing the output
 * printed to System.out and System.err in String form so that it can be
...
public class TextUITester {
  /**
   * This is the code being tested by the main method above. It 1) prints out a
   * welcome message, 2)
   * reads a String, a double, and a character from System.in, and then 3) prints
   * out the string
   * followed by a number that is one greater than that double, if the character
   * that it read in was
   * a (lower case) 'q'.
   */
  public static void run() {
    // Note to avoid instantiating more than one Scanner reading from System.in in
    // your code!
  ...
  // Below is the code that actually implements the redirection of System.in and
  // System.out,
  // and you are welcome to ignore this code: focusing instead on how the
  // constructor and
  ...
  /**
   * Creates a new test object with the specified string of simulated user input
   * text.
   * 
   * @param programInput the String of text that you want to simulate being typed
   *                     in by the user.
   */
   ...
   * text was printed
   * out to System.out and System.err. Calling this method will also un-redirect
   * standard io, so
   * that the console can be used as normal again.
   * 
   * @return captured text that was printed to System.out and System.err durring
   *         test.
   */
