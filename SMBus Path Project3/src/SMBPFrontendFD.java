...
public class SMBPFrontendFD implements SMBPFrontendInterface
{
	...
	public char mainMenuPrompt()
	{
		...
		if(commandInput.length() != 1) return 0;
	...
	public void newStop() 
	{
		...
		try {
			...
			backend.insertStop(new BusStopDW(inputNameString, new LinkedList<>(), new LinkedList<>()));
		}
		catch(Exception e)
		{
	...
	public void deleteStop() 
	{
		...
		try {
			...
			inputNameString = input.nextLine().trim();
			backend.removeStop(new BusStopDW(inputNameString, new LinkedList<>(), new LinkedList<>()));
		}
		catch(Exception e)
		{
	...
	public void newStreet() 
	{
		...
		try {
			backend.insertStreet(new BusStopDW(inputNameString1, new LinkedList<>(), new LinkedList<>()), 
					new BusStopDW(inputNameString2, new LinkedList<>(), new LinkedList<>()), time);
		}
		catch(Exception e)
		{
	...
	public void deleteStreet() 
	{
		...
		try {
			backend.removeStreet(new BusStopDW(inputNameString1, new LinkedList<>(), new LinkedList<>()), 
					new BusStopDW(inputNameString2, new LinkedList<>(), new LinkedList<>()));
		}
		catch(Exception e)
		{
	...
	public void shortestPath() 
	{
		...
		try {
			...
			System.out.println("Enter the second stop: ");
			inputNameString2 = input.nextLine().trim();
			backend.shortestBusPath(new BusStopDW(inputNameString1, new LinkedList<>(), new LinkedList<>()), 
					new BusStopDW(inputNameString2, new LinkedList<>(), new LinkedList<>()));
		}
		catch(Exception e)
		{
		...
		System.out.println("Shortest Path: " + backend.shortestBusPath(new BusStopDW(inputNameString1, 
				...
				new BusStopDW(inputNameString1, new LinkedList<>(), new LinkedList<>())).toString());
	...
	public void shortestCost() 
	{
		...
		try {
			...
			System.out.println("Enter the second stop: ");
			inputNameString2 = input.nextLine().trim();
			backend.shortestBusPathCost(new BusStopDW(inputNameString1, new LinkedList<>(), new LinkedList<>()), 
					new BusStopDW(inputNameString1, new LinkedList<>(), new LinkedList<>()));
		}
		catch(Exception e)
		{
			System.out.println("Invalid stops!");
	...
	public void shortestPathMultiple()
	{
		...
		try {
			...
			list.add(new BusStopDW(inputNameString1, new LinkedList<>(), new LinkedList<>()));
			list.add(new BusStopDW(inputNameString2, new LinkedList<>(), new LinkedList<>()));
			list.add(new BusStopDW(inputNameString3, new LinkedList<>(), new LinkedList<>()));
